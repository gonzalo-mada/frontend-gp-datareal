...
export class RangosAGMainService {
  ...
  async setModeCrud(mode: ModeForm, data?: RangosAG | null) {
  ...
  async getRangosAprobacion(showCountTableValues: boolean = true): Promise<RangosAG[]> {
  ...
  async deleteRegisters(dataToDelete: RangosAG[]) {
    try {

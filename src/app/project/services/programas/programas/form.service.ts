...
export class FormProgramaService {
  ...
  inputs: CardPrograma[] = [
    {id:1, col_lg: 4, col_md: 6, isEditable: true, haveSecondaryValue: false, modeDialog: 'centro costo' , collection: 'centro_costo' , items: [{title: 'Centro costo' , control: 'Centro_costo' , iconHelp: false}]},
    {id:2, col_lg: 4, col_md: 6, isEditable: true, haveSecondaryValue: false, modeDialog: 'nombre' , collection: 'nombre_programa' , items: [{title: 'Nombre' , control: 'Nombre_programa' ,   iconHelp: false}]},
    {id:3, col_lg: 4, col_md: 6, isEditable: true, haveSecondaryValue: false, modeDialog: 'grupo_correo' , collection: 'grupo_correo' , items: [{title: 'Grupo de correo en LDAP' , control: 'Grupo_correo' ,   iconHelp: false}]},
    {id:4, col_lg: 4, col_md: 6, isEditable: false, haveSecondaryValue: false, modeDialog: undefined , collection: undefined , items: [{title: 'Código de programa' , control: 'Cod_Programa' , iconHelp: false}]},
    {id:5, col_lg: 4, col_md: 6, isEditable: true, haveSecondaryValue: false, modeDialog: 'código SIES' , collection: 'codigo_sies' , items: [{title: 'Código SIES' , control: 'Codigo_SIES' ,   iconHelp: false}]},
    {id:6, col_lg: 2, col_md: 6, isEditable: true, haveSecondaryValue: false, modeDialog: 'créditos totales' , collection: 'creditos_totales' , items: [{title: 'Créditos totales' , control: 'Creditos_totales' ,   iconHelp: false}]},
    {id:7, col_lg: 2, col_md: 6, isEditable: true, haveSecondaryValue: false, modeDialog: 'horas totales' , collection: 'horas_totales' , items: [{title: 'Horas totales' , control: 'Horas_totales' ,   iconHelp: false}]},
    {id:8, col_lg: 4, col_md: 6, isEditable: true, haveSecondaryValue: false, modeDialog: 'REXE' , collection: 'REXE' , items: [{title: 'REXE' , control: 'REXE' ,  iconHelp: false}]},
    {id:9, col_lg: 4, col_md: 6, isEditable: true, haveSecondaryValue: false, modeDialog: 'título' , collection: 'titulo' ,items: [{title: 'Título' , control: 'Titulo' ,   iconHelp: false}]},
    {id:10, col_lg: 4, col_md: 6, isEditable: true, haveSecondaryValue: false, modeDialog: 'grado académico' , collection: 'grado_academico' , items: [{title: 'Grado académico' , control: 'Grado_academico' ,   iconHelp: false}]},
    {id:11, col_lg: 4, col_md: 6, isEditable: true, haveSecondaryValue: true, modeDialog: 'tipo de programa' , collection: 'tipo_programa' , items: [{title: 'Tipo de programa (Categoría)' , control: '' ,   iconHelp: false, principalValue: 'form.tipoProgramaSelected' , secondaryName:'Categoría' , secondaryValue: 'form.tipoProgramaCategoriaSelected'}]},
    {id:12, col_lg: 4, col_md: 6, isEditable: true, haveSecondaryValue: false, modeDialog: 'campus' , collection: 'campus' , items: [{title: 'Campus' , control: '' ,   iconHelp: false, principalValue: 'form.campusSelected'}]},
    {id:13, col_lg: 4, col_md: 6, isEditable: true, haveSecondaryValue: false, modeDialog: 'estado acreditación' , collection: 'estados_acreditacion' , items: [{title: 'Estado de acreditación' , control: '' ,   iconHelp: false, principalValue: 'form.inputEstadoAcreditacion'}]},
    {id:14, col_lg: 4, col_md: 6, isEditable: true, haveSecondaryValue: true, modeDialog: 'estado maestro' , collection: 'estado_maestro' , items: [{title: 'Estado maestro' , control: '' ,   iconHelp: false, principalValue: 'form.inputEstadoMaestro', secondaryName:'Tipo de suspensión', secondaryValue: 'form.inputTipoSuspension'}]},
    {id:15, col_lg: 4, col_md: 6, isEditable: true, haveSecondaryValue: false, modeDialog: 'reglamento' , collection: 'reglamentos' , items: [{title: 'Reglamento' , control: '' ,   iconHelp: false, principalValue: 'form.inputReglamento'}]},
    {id:16, col_lg: 4, col_md: 6, isEditable: true, haveSecondaryValue: true, modeDialog: 'director' , collection: 'director' , items: [{title: 'Director(a)' , control: '' ,   iconHelp: false, principalValue: 'form.inputDirector.nombre', secondaryName: 'RUT', secondaryValue: 'form.inputDirector.rut'}]},
    {id:17, col_lg: 4, col_md: 12, isEditable: true, haveSecondaryValue: false, modeDialog: 'unidades académicas' , collection: 'unidades_academicas' , items: [{title: 'Unidades académicas', control: 'Unidades_academicas_Selected' ,   iconHelp: true, labelHelp: 'Organizadas por la facultad a la cual pertenecen'}]},
    {id:18, col_lg: 8, col_md: 12, isEditable: true, haveSecondaryValue: false, modeDialog: 'director alterno' , collection: 'directorAlterno' , 
      items: [
    ...
    {id:19, col_lg: 12, col_md: 12, isEditable: true, haveSecondaryValue: false, modeDialog: 'graduación colaborativa' , collection: 'graduacion_colaborativa', 
      items: [
    ...
    {id:20, col_lg: 12, col_md: 12, isEditable: true, haveSecondaryValue: false, modeDialog: 'certificación intermedia' , collection: 'certificacion_intermedia', 
      items: [

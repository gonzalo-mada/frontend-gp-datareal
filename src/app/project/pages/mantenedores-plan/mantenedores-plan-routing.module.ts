...
const routes: Routes = [
  ...
  {
    path: 'menciones',
    loadChildren: () => import('../mantenedores-plan/menciones/menciones.module').then((j) => j.MencionesModule),
    title: 'Menciones'
  },
  {
    path: 'regimenes',
    loadChildren: () => import('../mantenedores-plan/regimen/regimen.module').then((j) => j.RegimenModule),
    title: 'Régimen'
  },
  {
